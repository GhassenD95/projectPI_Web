 ...
 */
final class Version20250416091430 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE exercice (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, type_exercice ENUM('MUSCULATION', 'CARDIO', 'YOGA', 'PILATES', 'NATATION', 'HIIT', 'ZUMBA'), duree_minutes INT NOT NULL, sets INT NOT NULL, reps INT NOT NULL, image_url VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE installationsportive (id INT AUTO_INCREMENT NOT NULL, manager_id INT DEFAULT NULL, nom VARCHAR(255) NOT NULL, type_installation VARCHAR(50) NOT NULL, adresse VARCHAR(255) NOT NULL, capacite INT NOT NULL, is_disponible TINYINT(1) NOT NULL, image_url VARCHAR(255) NOT NULL, INDEX IDX_1D1894D0783E3463 (manager_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
